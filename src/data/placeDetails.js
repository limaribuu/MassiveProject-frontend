...
Selain benda-benda bersejarah, pengunjung juga dapat melihat replika rumah adat yang ditata lengkap dengan interior tradisionalnya. Suasana museum yang tenang menjadikannya cocok untuk wisata edukasi bagi pelajar maupun wisatawan umum.
        ...
        sidebar: {
            ...
            fasilitas: "Area parkir, pemandu lokal, ruang pameran, area foto"
        },
        sections: [
            {
                title: "Koleksi Utama",
                content:
                    "Museum Balaputra Dewa menyimpan koleksi arca batu dari masa Hindu-Buddha, prasasti kuno, koleksi etnografi suku-suku di Sumatera Selatan, hingga benda-benda tradisional seperti senjata dan peralatan rumah tangga."
            },
            {
                title: "Rumah Adat Limas",
                content:
                    "Salah satu daya tarik utama museum adalah rumah adat Limas yang berdiri di area luar. Pengunjung dapat masuk ke dalam rumah untuk melihat langsung bagaimana tata ruang tradisional masyarakat Palembang di masa lalu."
            }
        ],
        mapImage: "/img/peta-museum-balaputra.png",
...
Kini, area sekitar Benteng Kuto Besak menjadi ruang publik yang ramai dikunjungi wisatawan dan warga lokal, terutama pada sore dan malam hari. Lokasinya yang berhadapan langsung dengan Sungai Musi membuat pemandangan di sekitar benteng sangat menarik, apalagi saat matahari terbenam.
        ...
        sidebar: {
            ...
            hargaTiket: "Gratis (hanya bayar parkir)",
            fasilitas: "Area duduk, pedagang kaki lima, spot foto, area acara"
        },
        sections: [
            {
                title: "Sejarah Singkat",
                content:
                    "Benteng Kuto Besak dibangun pada abad ke-18 sebagai pusat pertahanan dan pemerintahan Kesultanan Palembang. Benteng ini menggantikan keraton lama yang berada di kawasan yang sama dan menjadi simbol kekuatan politik saat itu."
            },
            {
                title: "Aktivitas yang Bisa Dilakukan",
                content:
                    "Pengunjung dapat menikmati pemandangan Sungai Musi, berfoto dengan latar Jembatan Ampera, mencoba kuliner khas Palembang dari pedagang sekitar, serta menikmati suasana malam yang ramai dengan lampu-lampu kota."
            }
        ],
        mapImage: "/img/peta-bkb.png",
        ...
        sections: [
            {
                title: "Nilai Sejarah",
                content:
                    "Kampung Kapitan mencerminkan jejak komunitas Tionghoa yang telah lama menetap di Palembang. Rumah-rumah tua dan tata ruang kampung menggambarkan bagaimana komunitas tersebut beradaptasi dengan lingkungan lokal."
            },
            {
                title: "Pengalaman Berkunjung",
                content:
                    "Pengunjung dapat berjalan kaki menyusuri gang kecil, berinteraksi dengan warga, mengenal sejarah kampung, dan berfoto di depan rumah-rumah panggung yang unik. Beberapa tur juga menawarkan perjalanan menggunakan perahu dari tepi Sungai Musi."
            }
        ],
        mapImage: "/img/peta-kampung-kapitan.png",
...
Pada siang hari, jembatan ini tampak megah dengan latar Sungai Musi dan aktivitas perahu di bawahnya. Saat malam, lampu-lampu warna-warni menjadikan suasana sekitar jembatan semakin hidup dan romantis.
        ...
        sections: [
            {
                title: "Spot Foto Favorit",
                content:
                    "Beberapa spot populer adalah dermaga di sekitar Benteng Kuto Besak, area plaza di sekitar jembatan, dan perahu di Sungai Musi. Dari sini, pengunjung bisa mendapatkan sudut terbaik Jembatan Ampera, terutama saat matahari terbenam."
            },
            {
                title: "Kuliner di Sekitar Ampera",
                content:
                    "Di sekitar jembatan terdapat banyak penjual pempek, model, tekwan, dan kuliner khas Palembang lainnya. Menikmati makanan sambil melihat suasana Sungai Musi menjadi pengalaman yang tidak terlupakan."
            }
        ],
        mapImage: "/img/peta-ampera.png",
...
Selain nilai sejarahnya, Bukit Siguntang juga menawarkan suasana tenang jauh dari keramaian kota. Pengunjung dapat menikmati udara sejuk dan pemandangan hijau di sekitarnya.
        ...
        sections: [
            {
                title: "Nilai Sejarah dan Religi",
                content:
                    "Bukit Siguntang sering dikaitkan dengan cerita-cerita leluhur dan tokoh-tokoh penting dalam sejarah Melayu dan Sriwijaya. Banyak pengunjung yang datang untuk berziarah maupun sekadar mengenal sejarah."
            },
            {
                title: "Aktivitas di Bukit Siguntang",
                content:
                    "Selain berziarah, pengunjung dapat berjalan santai menikmati suasana bukit, berfoto di area hijau, dan membaca informasi sejarah yang tersedia di beberapa titik."
            }
        ],
        mapImage: "/img/peta-bukit-siguntang.png",
...
Selain unsur religi dan budaya Tionghoa yang kuat, Pulau Kemaro juga menawarkan pemandangan Sungai Musi dari sudut yang berbeda. Suasana pulau yang tenang membuat pengunjung betah berlama-lama.
        ...
        sections: [
            {
                title: "Legenda Tan Bun An & Siti Fatimah",
                content:
                    "Pulau Kemaro lekat dengan kisah cinta tragis Tan Bun An, saudagar dari Tiongkok, dan Siti Fatimah, putri bangsawan Palembang. Konon, peristiwa tenggelamnya kapal mereka meninggalkan pulau ini sebagai simbol kisah tersebut."
            },
            {
                title: "Cara Menuju Pulau",
                content:
                    "Pengunjung dapat menyewa perahu dari dermaga di sekitar Benteng Kuto Besak atau dermaga lain di tepi Sungai Musi. Perjalanan menuju pulau biasanya memakan waktu sekitar 15–20 menit tergantung titik keberangkatan."
            }
        ],
        mapImage: "/img/peta-pulau-kemaro.png",
        ...
        sections: [
            {
                ...
                content:
                    "Di Taman Purbakala, pengunjung dapat melihat berbagai artefak yang berkaitan dengan Kerajaan Sriwijaya, mulai dari struktur bangunan hingga arca batu yang ditemukan di sekitar Palembang."
            },
            {
                title: "Suasana Taman",
                content:
                    "Pepohonan rindang dan tata ruang yang luas membuat taman ini nyaman untuk berjalan santai sambil belajar sejarah. Beberapa spot juga cocok dijadikan tempat berfoto."
            }
        ],
        mapImage: "/img/peta-taman-purbakala.png",
...
Lorong Basah Night Culinary adalah destinasi kuliner malam yang populer di Palembang. Di sepanjang lorong ini berjajar kios dan gerobak yang menjual berbagai makanan, mulai dari kuliner khas Palembang hingga jajanan modern. Lampu-lampu dan dekorasi di malam hari membuat suasana semakin meriah.
        ...
        sections: [
            {
                title: "Kuliner yang Wajib Dicoba",
                content:
                    "Beberapa menu favorit di Lorong Basah adalah pempek, tekwan, model, sate, dan aneka minuman segar. Selain itu ada juga jajanan kekinian yang digemari anak muda."
            },
            {
                title: "Suasana Malam",
                content:
                    "Lorong ini biasanya mulai ramai setelah magrib hingga larut malam. Lampu-lampu warna-warni dan musik dari beberapa kios menambah kesan ramai dan hangat."
            }
        ],
        mapImage: "/img/peta-lorong-basah.png",
        ...
        sections: [
            {
                ...
                content:
                    "Kompleks ini memiliki fasilitas modern untuk sepak bola, atletik, renang, dayung, dan cabang olahraga lainnya. Banyak event besar pernah digelar di sini, termasuk PON dan Asian Games."
            },
            {
                title: "Aktivitas Rekreasi",
                content:
                    "Selain olahraga, pengunjung dapat jogging di sekitar danau, bersepeda, atau sekadar berjalan santai menikmati suasana hijau di kawasan Jakabaring."
            }
        ],
        mapImage: "/img/peta-jakabaring.png",
...
Bayt Al-Quran Al-Akbar dikenal sebagai tempat yang menyimpan Al-Quran raksasa yang diukir pada lembaran kayu. Ukiran ayat-ayat suci yang detail dan megah menjadikannya salah satu destinasi religi paling unik di Palembang.
        ...
        sidebar: {
            ...
            hargaTiket: "Dewasa: Rp10.000\nPelajar: Rp5.000",
            fasilitas: "Area parkir, pemandu, ruang pameran, area foto"
        },
        sections: [
            {
                title: "Keunikan Al-Quran Ukir",
                content:
                    "Al-Quran di sini diukir pada lembaran kayu besar dengan ornamen yang indah. Setiap halaman menampilkan ayat-ayat suci yang diukir dengan ketelitian tinggi."
            },
            {
                title: "Wisata Religi",
                content:
